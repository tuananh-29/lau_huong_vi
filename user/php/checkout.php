...
// 2. Giỏ hàng không được rỗng
if (empty($_SESSION['cart'])) {
    header("Location: menu.php"); // Nếu giỏ rỗng, quay về trang thực đơn
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 2. Lấy thông tin sản phẩm từ CSDL (để đảm bảo giá đúng)
    ...
    try {
        ...
        // 5. TẠO CHI TIẾT ĐƠN HÀNG (Bảng chi_tiet_don)
        ...
        // 7. Xóa giỏ hàng và báo thành công
        unset($_SESSION['cart']);
    ...
    <main>
        <section class="auth-page">
            <div class="container">
                ...
                <?php if (!empty($_SESSION['cart'])): // Chỉ hiện form nếu chưa đặt hàng thành công ?>
